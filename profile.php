...
<div class="super_container">
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				<li class="menu_mm"><a href="profile.php">Home</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Profile</div>
							<form action="scripts/profile.php" class="comment_form" method="POST">
								<div><img src="images/profilepic.png" alt=""/></div>
								<br>
								<div class="form_title">
									...
									<div>
									<button type="submit" class="comment_button trans_200">Edit</button>
									</div>
									<br><br>
									<div class="contact_info_title">Test Marks</div>
									<br><br>
									<table class="table">
										<tr>
