				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">MCQ</div>
							<form action="#" class="comment_form">
								<div>
								  <p>1)&emsp;
									  <label>I. 
									    <input type="radio" name="q1" value="one" id="q1_0">
									    </label>&ensp;
									  <label>II. 
									    <input type="radio" name="q1" value="two" id="q1_1">
									    </label>&ensp;
									  <label>III. 
									    <input type="radio" name="q1" value="three" id="q1_2">
									    </label>&ensp;
									  <label>IV. 
									    <input type="radio" name="q1" value="four" id="q1_3">
									    </label>&ensp;
									  <label>V. 
									    <input type="radio" name="q1" value="five" id="q1_4">
									    </label>
								  </p>
                                </div>
								<div>
